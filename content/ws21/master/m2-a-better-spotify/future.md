...
So far, there are only extensions to browsers that make it possible for the user to have keyboard shortcuts, which is definitely a missed opportunity when it comes to the **usability** of the app. Especially thinking about people not being able to click precisely with a mouse would have it much easier pressing one or two buttons to achieve the same thing. **Inclusivity** is something that definitely needs to be a part of a web application's design. 
